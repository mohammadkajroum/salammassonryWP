...
let loadButtonWrapper = document.querySelector(".vidcast-load-posts-btn-wrapper");
let loadButton = document.querySelector(
    ".vidcast-load-posts-btn-wrapper .load-btn"
);
let loader = document.querySelector(".vidcast-ajax-loader");
let articleWrapper = document.querySelector(".vidcast-article-wrapper");
    ...
    fetchThePosts: function () {
        ...
        fetch(VidcastVars.ajaxurl, {
            ...
            body: new URLSearchParams({
                action: "vidcast_load_posts",
                nonce: VidcastVars.nonce,
                query_vars: VidcastVars.query_vars,
                page: nextPage,
            }),
        })
            .then((response) => {
