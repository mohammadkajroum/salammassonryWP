...
$related_posts_text = vidcast_get_option('related_posts_text');
$no_of_related_posts = absint(vidcast_get_option('no_of_related_posts'));
$order = esc_attr(vidcast_get_option('related_posts_order'));
$orderby = esc_attr(vidcast_get_option('related_posts_orderby'));
