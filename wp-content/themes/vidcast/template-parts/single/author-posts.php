...
$author_posts_text = vidcast_get_option('author_posts_text');
$no_of_author_posts = absint(vidcast_get_option('no_of_author_posts'));
$order = esc_attr(vidcast_get_option('author_posts_order'));
$orderby = esc_attr(vidcast_get_option('author_posts_orderby'));
