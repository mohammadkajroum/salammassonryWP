 ...
 * @package Vidcast
 */
$ed_header_type = vidcast_get_option( 'ed_header_type' );
$upload_add_image = vidcast_get_option( 'upload_add_image' );
$ed_header_link = vidcast_get_option( 'ed_header_link' );
$advertisement_section_title = vidcast_get_option( 'advertisement_section_title' );
?>
            ...
            <header class="welcome-screen-header">
                ...
                <div class="welcome-screen-actions">
                    ...
                    <button type="button" class="welcome-screen-skip">
                        <?php echo esc_html__('Skip This', 'vidcast') ?>
                    </button>
                </div>
            </header>
        <?php } ?>
