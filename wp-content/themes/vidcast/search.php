...
$archive_title = sprintf(
    '%1$s %2$s',
    '<span class="color-accent">' . __('Search:', 'vidcast') . '</span>',
...
if ($wp_query->found_posts) {
    ...
    $archive_subtitle = __('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vidcast');
}
                ...
                <?php if (have_posts()) : ?>
                    <header class="page-header">
                        <h1 class="page-title">
                            ...
                            printf(esc_html__('Search Results for: %s', 'vidcast'), '<span>' . get_search_query() . '</span>');
                            ?>
                        </h1>
                    </header><!-- .page-header -->
                    <?php
                    echo '<div class="vidcast-article-wrapper vidcast-' . esc_attr($archive_style) . '">';
                    /* Start the Loop */
                    while (have_posts()) :
                        the_post();
                        /**
                    ...
                    endwhile;
                    echo '</div><!-- .vidcast-article-wrapper -->';
                    ...
                    <div class="no-search-results-form">
                        ...
                        get_search_form(
                            array(
                                'aria_label' => __('search again', 'vidcast'),
                            )
                        );
                        ?>
