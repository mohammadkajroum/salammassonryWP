<?php
if( !function_exists('vidcast_custom_taxonomy_field') ):

	// Add term page
    function vidcast_custom_taxonomy_field(){
        ...
        <div class="form-field">
            ...
            <label><?php esc_html_e('Feature Image', 'vidcast'); ?></label>
...
add_action('category_add_form_fields', 'vidcast_custom_taxonomy_field', 10, 2);


if( !function_exists('vidcast_taxonomy_edit_meta_field') ):

	// Edit term page
    function vidcast_taxonomy_edit_meta_field($term){

        $twp_term_image = get_term_meta( $term->term_id, 'twp-term-featured-image', true ); ?>
        <tr>
            
            <th scope="row" valign="top"><label><?php esc_html_e('Feature Image', 'vidcast'); ?></label></th>
...
add_action('category_edit_form_fields', 'vidcast_taxonomy_edit_meta_field', 10, 2);
