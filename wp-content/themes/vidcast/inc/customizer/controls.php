 ...
 */
class Vidcast_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
        ...
        $dropdown_args = wp_parse_args( $this->dropdown_args, array(
            ...
            'show_option_none'  => __( '&mdash; Select &mdash;', 'vidcast' ),
            'selected'          => $this->value(),
            'show_option_all'   => '',
            'orderby'           => 'id',
            'order'             => 'ASC',
 ...
 * @see WP_Customize_Control
 */
class Vidcast_Radio_Image_Control extends WP_Customize_Control {
...
class Vidcast_Checkbox_Multiple extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Vidcast_Seperator_Control extends WP_Customize_Control {
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Vidcast_Premium_Notice_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <span class="customize-control-title">
                <div class="theme-assist-info">
                    ...
                    <span class="theme-assist-label"><?php echo esc_html__('More ','vidcast'). esc_html( $this->label ). esc_html__(' Available on Premium Version.', 'vidcast' ); ?></span>
                </div>
            </span>
