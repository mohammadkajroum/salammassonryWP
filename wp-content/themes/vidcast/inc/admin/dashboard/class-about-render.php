...
class Vidcast_Theme_Dashboard
{
    ...
    public $settings = array(
        'tabs' => array(),
        'demo_link' => 'https://live-demo.themeinwp.net/vidcast',
    ...
    public function __construct()
    {
        ...
        add_action('wp_ajax_vidcast_dismissed_handler', array($this, 'dismissed_handler'));
        ...
        if( isset( $_GET['page'] ) && $_GET['page'] == 'theme-dashboard' ){
            ...
            add_action('in_admin_header', array( $this,'vidcast_hide_all_admin_notice' ),1000 );

        }
    }


    public function vidcast_hide_all_admin_notice(){
    ...
    {
        add_submenu_page('themes.php', esc_html__('Vidcast Dashboard', 'vidcast'), esc_html__('Theme Dashboard', 'vidcast'), 'manage_options', $this->menu_slug, array($this, 'html_carcase'), 1);
    }
    ...
    {
        wp_enqueue_script('vidcast', get_template_directory_uri() . '/inc/admin/dashboard/js/scripts.js', array('jquery'), filemtime(get_template_directory() . '/inc/admin/dashboard/js/scripts.js'), true);
        $ajax_dismiss_notice_nonce = wp_create_nonce('vidcast_dismiss_notice_nonce');
        wp_localize_script('vidcast', 'vidcast_localize', array(
            'ajax_url' => admin_url('admin-ajax.php'),
            'nonce' => wp_create_nonce('nonce'),
            'dismiss_notice_nonce' => $ajax_dismiss_notice_nonce,
            'upload_image'   =>  esc_html__('Choose Image','vidcast'),
            'use_image'   =>  esc_html__('Select','vidcast'),
            'active' => esc_html__('Active','vidcast'),
            'deactivate' => esc_html__('Deactivate','vidcast'),
            'failed_message' => esc_html__('Something went wrong, contact support.', 'vidcast'),
        ));

        // Styles.
        wp_enqueue_style('vidcast', get_template_directory_uri() . '/inc/admin/dashboard/css/style.css', array(), filemtime(get_template_directory() . '/inc/admin/dashboard/css/style.css'));

        // Add RTL support.
        wp_style_add_data('vidcast', 'rtl', 'replace');
    }
                    ...
                    <div class="dashboard-feature-row dashboard-feature-row-bottom">
                        ...
                        if (isset($feature['activate_uri']) && $feature['activate_uri']) {
                            ...
                            <a href="<?php echo esc_attr($customize_uri); ?>" class="dashboard-feature-item-customize"
                               target="_blank">
                                <?php esc_html_e('Customize', 'vidcast'); ?>
                            </a>
                        <?php } ?>
                    </div>
                </div>
        ...
        <div class="suggested-enhancement">
                ...
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Fastest WordPress Hosts', 'vidcast'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('A slow host can really put a drag on your site’s performance, even an optimized one. Make sure you get a host that won’t hold you back by reading our review, complete with real speed tests, of the fastest WordPress hosts. ', 'vidcast'); ?>
                        </div>

                        <a class="suggested-enhancement-link" href="<?php echo esc_url($this->settings['insights_link_1']); ?>" target="_blank">
                            <?php esc_html_e('Read more', 'vidcast'); ?>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('WP Rocket Review', 'vidcast'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('Every site that is serious about speed (and should be pretty much all sites these days) needs a caching plugin and WP Rocket is our pick of the bunch. Get the lowdown on why we recommend it n our data-backed review: ', 'vidcast'); ?>
                        </div>
            ...
            <div class="suggested-enhancement-item suggested-enhancement-item-half">
                <div class="suggested-enhancement-panel">
                    ...
                    <div class="suggested-enhancement-content">
                        <div class="suggested-enhancement-title">
                            <?php esc_html_e('Best WordPress Speed Optimization Plugins', 'vidcast'); ?>
                        </div>

                        <div class="suggested-enhancement-description">
                            <?php esc_html_e('We run through the top 10 WordPress performance plugins to keep your site running fast. Goes beyond just caching plugins (though those are on there too!). A must-read for all WordPress site owners.', 'vidcast'); ?>
                        </div>
                ...
                <div class="theme-admin-button-wrap theme-admin-button-group">
                    ...
                    <?php if ('themes.php' === $pagenow && 'themes' === $screen->base) { ?>
                        <a href="<?php echo esc_url(add_query_arg('page', $this->menu_slug, admin_url('themes.php'))); ?>" class="button theme-admin-button admin-button-primary">
                            ...
                            <span><?php esc_html_e('Theme Dashboard', 'vidcast'); ?></span>
                        </a>
                    <?php } ?>
                    ...
                    <a href="<?php echo esc_url($this->settings['demo_link']); ?>" class="button theme-admin-button admin-button-secondary" target="_blank">
                        ...
                        <span><?php esc_html_e('View Live Demo', 'vidcast'); ?></span>
                    </a>
                    ...
                    <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-admin-button admin-button-secondary" target="_blank">
                        ...
                        <span><?php esc_html_e('Theme Documentation', 'vidcast'); ?></span>
                    </a>
                </div>
                    ...
                    <div class="dashboard-header-panel">
                        <div class="dashboard-masthead-item dashboard-masthead-left">
                            <a href="<?php echo esc_url('https://themeinwp.com/'); ?>" class="theme-author-logo" target="_blank">
                                <img src="<?php echo esc_url(get_template_directory_uri() . '/inc/admin/dashboard/images/vidcast-logo.png'); ?>" alt="<?php esc_attr_e('ThemeinWP', 'vidcast'); ?>">
                            </a>
                        </div>
                        ...
                        <div class="dashboard-masthead-item dashboard-masthead-right">
                            <a href="<?php echo esc_url($this->settings['documentation_link']); ?>" class="button theme-button-small theme-admin-button admin-button-secondary" target="_blank">
                                <span><?php esc_html_e('Documentation', 'vidcast'); ?></span>
                        ...
                        <div class="dashboard-hero-main-sidebar">
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-review">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title"><?php esc_html_e('Review', 'vidcast'); ?></h3>
                                </div>
                                <div class="dashboard-panel-content">
                                    ...
                                    <div class="theme-admin-description"><?php esc_html_e('It makes us happy to hear from our users. We would appreciate a review.', 'vidcast'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['review_link']); ?>"
                                           class="theme-admin-button button" target="_blank">
                                            <?php esc_html_e('Submit a Review', 'vidcast'); ?>
                                        </a>
                                    </div>

                                    <div class="theme-admin-separator"></div>

                                    <div class="theme-admin-title"><?php esc_html_e('Have an idea or feedback?', 'vidcast'); ?></div>

                                    <div class="theme-admin-description">
                                        <?php esc_html_e('If you have any suggestions or comments about our WordPress theme, please let us know. We value your feedback and strive to continuously improve our product.', 'vidcast'); ?>
                                    </div>

                                    <a href="<?php echo esc_url($this->settings['suggest_idea_link']); ?>" class="theme-feature-request" target="_blank">
                                        <?php esc_html_e('Suggest an Idea', 'vidcast'); ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="theme-dashboard-panel dashboard-panel-changelog">
                                <div class="dashboard-panel-head">
                                    <h3 class="dashboard-panel-title">
                                        <?php esc_html_e('Changelog', 'vidcast'); ?>
                                    </h3>
                                ...
                                <div class="dashboard-panel-content">
                                    <div class="theme-admin-description"><?php esc_html_e('The theme changelog provides a brief history of updates and modifications made to the theme. Keep informed with the changes and improvements that have been made over time.', 'vidcast'); ?></div>

                                    <a href="<?php echo esc_url($this->settings['changelog_link']); ?>"
                                       class="theme-changelog-info" target="_blank">
                                        <?php esc_html_e('See the Changelog', 'vidcast'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="dashboard-wrapper">
                    <div class="dashboard-footer-panel">
                        <div class="theme-dashboard-panel dashboard-panel-support">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Support', 'vidcast'); ?></h3>

                                <?php if ($this->pro_status) { ?>
                                    <div class="theme-dashboard-badge theme-badge-primary"><?php esc_html_e('Priority Status', 'vidcast'); ?></div>
                                <?php } ?>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-dashboard-subpanel">
                                    <div class="theme-admin-title">
                                        <?php echo wp_kses_post(__('Need help? We\'re here for you!', 'vidcast')); ?>
                                    </div>

                                    <div class="theme-admin-description"><?php esc_html_e('Do you have a question or have you encountered a bug? You can receive assistance from our amicable support team whenever you require it.', 'vidcast'); ?></div>

                                    <div class="theme-admin-button-wrap">
                                        <a href="<?php echo esc_url($this->settings['support_link']); ?>"
                                           class="button theme-admin-button admin-button-secondary" target="_blank">
                                            <?php esc_html_e('Get Support', 'vidcast'); ?>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <?php if (!$this->pro_status) { ?>
                                    <div class="theme-dashboard-subpanel dashboard-subpanel-bg">
                                        <div class="theme-admin-title">
                                            <?php echo wp_kses_post(__('Upgrade to priority support', 'vidcast')); ?>

                                            <div class="theme-dashboard-badge theme-badge-secondary"><?php esc_html_e('pro', 'vidcast'); ?></div>
                                        </div>

                                        <div class="theme-admin-description">
                                            <?php esc_html_e('Receive support via email with a prompt initial response time of 1-2 hours for all priority requests.', 'vidcast'); ?>
                                        </div>

                                        <div class="theme-admin-button-wrap">
                                            <a href="<?php echo esc_url($this->settings['support_pro_link']); ?>"
                                               class="button theme-admin-button admin-button-primary" target="_blank">
                                                <?php esc_html_e('Get Priority Support', 'vidcast'); ?>
                                            </a>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="theme-dashboard-panel dashboard-panel-community">
                            <div class="dashboard-panel-head">
                                <h3 class="dashboard-panel-title"><?php esc_html_e('Community', 'vidcast'); ?></h3>
                            </div>
                            <div class="dashboard-panel-content">
                                <div class="theme-admin-title">
                                    <?php echo wp_kses_post(__('Join Our Community', 'vidcast')); ?>
                                </div>

                                <div class="theme-admin-description"><?php esc_html_e('Engage with the community: talk about products, ask for help or offer assistance to the community.', 'vidcast'); ?></div>

                                <div class="theme-admin-button-wrap">
                                    <a href="<?php echo esc_url($this->settings['community_link']); ?>"
                                       class="button theme-admin-button admin-button-tertairy" target="_blank">
                                        <?php esc_html_e('Join Now', 'vidcast'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
    ...
    public function notice()
    {
        ...
        if ('themes.php' === $pagenow) {
            ...
            if (!get_transient($transient_name)) {
                ...
                ?>
                <div class="notice notice-success vidcast-primary-notice theme-admin-dashboard theme-admin-dashboard-notice is-dismissible" data-notice="<?php echo esc_attr($transient_name); ?>">
    ...
    {
        check_ajax_referer( 'vidcast_dismiss_notice_nonce', 'security' );
