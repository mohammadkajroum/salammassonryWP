...
class Vidcast_Tab_Posts extends Vidcast_Widget_Base
{
    /**
    ...
    {
        $this->widget_cssclass = 'vidcast-widget-tab';
        $this->widget_description = __("Displays Tab Widget", 'vidcast');
        $this->widget_id = 'vidcast_tab_posts';
        $this->widget_name = __('Vidcast: Tab Posts', 'vidcast');
        $this->settings = array(
            'popular_heading' => array(
                'label' => esc_html__('Popular', 'vidcast'),
                'type' => 'heading',
            ),
            'popular_number' => array(
                'label' => esc_html__('No. of Posts:', 'vidcast'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'std' => 5,
                'min' => 1,
            ...
            'recent_heading' => array(
                'label' => esc_html__('Recent', 'vidcast'),
                'type' => 'heading',
            ),
            'recent_number' => array(
                'label' => esc_html__('No. of Posts:', 'vidcast'),
            ...
            'comments_heading' => array(
                'label' => esc_html__('Comments', 'vidcast'),
                'type' => 'heading',
            ),
            'comments_number' => array(
                'label' => esc_html__('No. of Comments:', 'vidcast'),
                'type' => 'number',
                'css' => 'max-width:60px;',
                'std' => 5,
                'min' => 1,
            ...
            'tagged_heading' => array(
                'label' => esc_html__('Tagged', 'vidcast'),
                'type' => 'heading',
            ),
            'select_image_size' => array(
                'label' => esc_html__('Select Image Size Featured Post:', 'vidcast'),
                'type' => 'select',
                'std' => 'medium',
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'vidcast'),
                    'medium' => esc_html__('Medium', 'vidcast'),
                    'large' => esc_html__('Large', 'vidcast'),
                    'full' => esc_html__('Full', 'vidcast'),
                ),
            ),
            'title_size' => array(
                'type' => 'select',
                ...
                <ul class="tab-header-list" role="tablist">
                    <li role="presentation" tab-data="tab-popular" class="widget-tab-presentation tab-popular active">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-popular-tabpanel"
                           role="tab">
                            <span class="screen-reader-text"><?php _e('Popular', 'vidcast'); ?></span>
                            <span class="fire-icon tab-icon">
                                <?php vidcast_theme_svg('blaze'); ?>
                            </span>
                        </a>
                    </li>
                    <li role="presentation" tab-data="tab-recent" class="widget-tab-presentation tab-recent">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-recent-tabpanel"
                           role="tab">
                            <span class="screen-reader-text"><?php _e('Recent', 'vidcast'); ?></span>
                            <span class="flash-icon tab-icon">
                                <?php vidcast_theme_svg('star'); ?>
                            </span>
                        </a>
                    </li>
                    <li role="presentation" tab-data="tab-comments" class="widget-tab-presentation tab-comments">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-comments-tabpanel"
                           role="tab">
                            <span class="screen-reader-text"><?php _e('Comment', 'vidcast'); ?></span>
                    ...
                    <li role="presentation" tab-data="tab-tagged" class="widget-tab-presentation tab-tagged">
                        <a href="javascript:void(0)" aria-controls="<?php echo $args['widget_id']; ?>-tagged-tabpanel"
                           role="tab">
                            <span class="screen-reader-text"><?php _e('Tagged', 'vidcast'); ?></span>
                            <span class="comment-icon tab-icon">
                                <?php vidcast_theme_svg('tag'); ?>
                            </span>
                        </a>
                    </li>
                </ul>
